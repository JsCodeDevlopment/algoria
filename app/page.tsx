...
export default async function HomePage() {
  ...
  return (
    <div className="relative overflow-hidden">
      <div className="absolute top-0 left-0 h-full w-full pointer-events-none -z-10 bg-grid-pattern opacity-10" />
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 pt-20 pb-16 md:pt-28 md:pb-24">
        <div className="animate-in flex max-w-4xl flex-col items-start gap-8">
          ...
          <h1 className="text-5xl font-black uppercase leading-[0.92] tracking-tighter md:text-8xl md:leading-[0.9]">
            ...
            <span className="text-primary">Entende o algoritmo.</span>
          </h1>
      ...
      {/* ── Métricas reais ── */}
      <section aria-label="Escala do catálogo" className="relative z-10 border-y border-border bg-muted/40">
