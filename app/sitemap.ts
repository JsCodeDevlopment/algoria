...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/changelog`, lastModified: now, priority: 0.72, changeFrequency: 'weekly' },
    { url: `${BASE_URL}/pricing`, lastModified: now, priority: 0.86, changeFrequency: 'weekly' },
    { url: `${BASE_URL}/legal/terms`, lastModified: now, priority: 0.45, changeFrequency: 'yearly' },
    { url: `${BASE_URL}/legal/privacy`, lastModified: now, priority: 0.45, changeFrequency: 'yearly' },
    { url: `${BASE_URL}/legal/cookies`, lastModified: now, priority: 0.4, changeFrequency: 'yearly' },
    { url: `${BASE_URL}/legal/refunds`, lastModified: now, priority: 0.4, changeFrequency: 'yearly' },
