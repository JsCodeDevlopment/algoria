...
const ALL_TYPES = [
  {
    value: 'interview-en',
    label: 'Interview EN',
    description: 'Vocabulário técnico, frases e simulações de entrevistas em inglês para engenheiros de software.',
  ...
  },
  {
    ...
    label: 'Engenharia',
    description: 'Guias práticos sobre processos, cultura, carreira e boas práticas no dia-a-dia de engenharia.',
  ...
  },
  {
    value: 'problem',
    label: 'Problema',
    description: 'Desafios de algoritmos e estruturas de dados com exemplos, constraints e soluções anotadas.',
  ...
  },
  {
    value: 'concept',
    label: 'Conceito',
    description: 'Mini-guias teóricos sobre fundamentos de computação: arrays, grafos, complexidade, etc.',
  ...
  },
  {
    value: 'course',
    label: 'Curso',
    description: 'Trilhas de aprendizado estruturadas com módulos, exercícios MCQ e certificado de conclusão.',
  ...
  },
  {
    ...
    description: 'Avaliações técnicas com quiz + desafio de código para medir conhecimento prático.',
...
export function ContentTypeSelector({ userName, userRole, userImage, isAdmin }: ContentTypeSelectorProps) {
    ...
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground max-w-2xl">
          Cada tipo de conteúdo possui um formulário específico adaptado à sua estrutura.
          Selecione o tipo para começar.
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {allowedTypes.map((type) => (
          <button
            key={type.value}
            onClick={() => router.push(`/admin/content/editor?type=${type.value}`)}
          ...
          >
            {/* Gradient bg */}
            <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${type.color} opacity-0 transition-opacity group-hover:opacity-100`} />
