...
export interface CodeChallenge {
  ...
  initialCode: string;
  testCases: TestCase[];
  // The name of the function the user must implement
  functionName: string;
}
...
function debounce(func, wait) {
  ...
  return function(...args) {
      ...
      testCases: [
        {
          id: 'tc1',
          description: 'A função deve ser executada após o tempo de espera',
          assertion: `
            (async () => {
              let count = 0;
        ...
        {
          id: 'tc2',
          description: 'Múltiplas chamadas rápidas devem ser ignoradas, executando apenas a última',
          assertion: `
            (async () => {
              let count = 0;
              const debounced = debounce(() => count++, 50);
        ...
        {
          id: 'tc3',
          description: 'Deve manter os argumentos da última chamada',
          assertion: `
            (async () => {
              let result = 0;
