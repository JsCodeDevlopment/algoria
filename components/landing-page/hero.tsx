  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      requestAnimationFrame(() => {
        setShowAnimations(mediaQuery.matches);
      });

      const handler = (e: MediaQueryListEvent) => setShowAnimations(e.matches);
      ...
      <section className="relative z-10 mx-auto flex flex-1 max-w-7xl flex-col justify-center px-6 py-8 md:py-12">
        <div className="grid items-center gap-16 lg:grid-cols-[1.2fr_430px] lg:gap-12">
          <div className="max-w-3xl space-y-9">
            <div className="opacity-0 animate-fade-in-up flex items-center gap-4">
            ...
            <h1
              className="opacity-0 animate-fade-in-up text-[1.8rem] font-black uppercase leading-[0.92] tracking-tighter md:text-6xl md:leading-[0.88] lg:text-8xl"
            ...
            <p
              className="opacity-0 animate-fade-in-up max-w-xl border-l-[3px] border-primary/35 pl-6 text-lg leading-relaxed text-muted-foreground md:text-xl md:leading-relaxed"
            ...
            <div
              className="opacity-0 animate-fade-in-up flex flex-col gap-4 sm:flex-row sm:items-center"
