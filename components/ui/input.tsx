...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  return (
    <input
      ref={ref}
      className={cn(
        'flex h-9 w-full min-w-0 rounded-none border border-zinc-200 bg-white px-3 py-1 text-sm shadow-xs transition-colors outline-none placeholder:text-zinc-400 dark:border-zinc-800 dark:bg-zinc-950 dark:placeholder:text-zinc-600',
