...
const badgeVariants = cva(
  'inline-flex items-center gap-1 rounded-none border px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider leading-none whitespace-nowrap transition-colors shadow-sm',
  {
    variants: {
      variant: {
