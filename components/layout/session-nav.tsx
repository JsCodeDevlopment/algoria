  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="group flex items-center gap-2 rounded-none border-2 border-border cursor-pointer p-1 pr-3 transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
      >
        <div className="flex h-7 w-7 shrink-0 items-center justify-center overflow-hidden rounded-none bg-primary/10 text-[10px] font-bold text-primary border border-border/50">
          {user.image ? (
            <Image
              src={user.image}
              alt={user.name || "Usuário Algoria Profile Picture"}
              width={28}
              height={28}
